...
ROOT_URLCONF = 'DjangoMedical.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'ReactMedical/medicalapp/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [ os.path.join(BASE_DIR,'ReactMedical/medicalapp/build/static')]
